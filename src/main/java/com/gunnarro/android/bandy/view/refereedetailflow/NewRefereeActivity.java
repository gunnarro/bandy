...
public class NewRefereeActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getSupportFragmentManager().beginTransaction().replace(R.id.referee_details_container_id, fragment).commit();
		// }
	}
