...
public class ContactsTable {
	...
	static {
		...
		DATABASE_CREATE_QUERY.append(",").append(COLUMN_FK_TEAM_ID).append(" INTEGER NOT NULL ON CONFLICT FAIL REFERENCES teams(_id) ON DELETE SET NULL ON UPDATE CASCADE");
