...
public class PlayerListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null && getArguments().containsKey(DashboardActivity.ARG_TEAM_NAME)) {
			String teamName = getArguments().getString(DashboardActivity.ARG_TEAM_NAME);
			if (teamName != null) {
				try {
					Team team = this.bandyService.getTeam(teamName, false);
					this.itemList = this.bandyService.getPlayersAsItemList(team.getId());
		...
		// String teamName = savedInstanceState.getString(ARG_TEAM_NAME, null);
		// if (teamName != null) {
		// Team team = bandyService.getTeam(teamName);
		// itemList = bandyService.getPlayersAsItemList(team.getId());
		// }
		// }
