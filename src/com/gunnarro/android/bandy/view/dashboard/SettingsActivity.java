...
//		init();
	...
	private void setupEventHandlers() {
		findViewById(R.id.load_data_btn).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				UpdateDataTask task = new UpdateDataTask(SettingsActivity.this);
	...
	private void init() {
		TextView dataFileUrlTxtView = (TextView) findViewById(R.id.data_file_url_txt);
		dataFileUrlTxtView.setText(bandyService.getDataFileUrl());
